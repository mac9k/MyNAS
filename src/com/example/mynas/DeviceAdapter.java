...
public class DeviceAdapter extends ArrayAdapter<FileTable> {
	
	private static final String TAG = "In_DeviceAdaptor";
	...
	public DeviceAdapter(Context context, int layoutResource, ArrayList<FileTable> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		if(Name.startsWith("[")&& Name.endsWith("]")){
			...
			long size = dList.get(position).getSize();
			if(size < KB)
